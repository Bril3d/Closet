...
import { View, Text, StyleSheet, Image, ScrollView, ActivityIndicator, TouchableOpacity, TextInput, FlatList, Dimensions, ViewStyle, TextStyle, ImageStyle, Alert } from 'react-native';
